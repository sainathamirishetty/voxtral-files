        ...
        while not exit_flag.is_set():
            try:
                if audio_queue_lst.empty():
                    ...
                    update_status(f"Processing audio file: {os.path.basename(file_path)}")
                    ...
                    update_status(f"Generating summary with max_tokens: {max_tokens}")
                    ...
                    update_status(f"✓ Audio chunk processed successfully")
